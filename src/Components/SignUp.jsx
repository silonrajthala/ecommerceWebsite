        ...
        return (
          <div className=' pt-32' >
           ...
           <div className='flex items-center justify-center w-full py-20 sm:py-5'>
              ...
              <form className=' p-10' > 
              <div className="mb-4">
                  <label htmlFor="username" className="block text-white font-semibold mb-2 text-left">Full Name</label>
                  <input
                    type="username"
                    id="username"
              ...
              <div className="mb-4">
                ...
                <h1 className='text-white text-left mt-5'>Already have account?<a href="/login" className=" px-3 text-blue-500 hover:text-blue-700">Sign In</a>
            </h1>
